...
class OpinionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create opinion" do
    assert_difference('Opinion.count') do
      post opinions_url, params: { opinion: { explanation: @opinion.explanation, preview: @opinion.preview, user_id: @opinion.user_id } }
    end
  ...
  test "should update opinion" do
    patch opinion_url(@opinion), params: { opinion: { explanation: @opinion.explanation, preview: @opinion.preview, user_id: @opinion.user_id } }
